...
> Note: if you are managing an Aserto tenant for an organization, we recommend using a GitHub "bot account" to sign in with, which has access to your GitHub organization.
