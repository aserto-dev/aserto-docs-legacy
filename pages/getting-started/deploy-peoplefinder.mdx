...
Clicking on any of the users will show their information. Note that users can click the “Edit” button and edit their own information (phone number), but can’t update other user’s information. If you click on Karen, try to change her phone number, and Save, you’ll get an error.
