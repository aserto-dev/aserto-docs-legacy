...
> Note: Aserto is currently in private beta. You need an invitation to create an account. To obtain an invitation, please complete our [sign-up form](https://wwww.aserto.com/sign-up).
...
This command returns the tenants the current account is registered with. It also returns the default 
tenant. 

## Next Steps

Learn about Aserto tenants and managing them.
