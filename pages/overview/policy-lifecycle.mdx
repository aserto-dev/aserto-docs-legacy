...
passing it the user, resource, and policy, and the Authorizer will evaluate the policy with the provided 
inputs and returns a boolean result of whether the user has access to the resource based on the given policy.
