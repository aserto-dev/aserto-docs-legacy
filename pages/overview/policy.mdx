...
A policy is expressed in a declarative language called [rego](https://www.openpolicyagent.org/docs/latest/policy-language/).
...
> `policy-name`.`HTTP method`.`HTTP route`
