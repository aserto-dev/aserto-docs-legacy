...
The Authorizer is an open source authorization engine which uses the Open Policy Agent (OPA) to 
compute a *decision* based on a *policy*, *user context*, and *data*. It is most commonly deployed 
close to your application, to offer the lowest latency and the highest level of availability to 
your application.
