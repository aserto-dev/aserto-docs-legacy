...
It is used by the the `displayStateMap` middleware in SDKs such as the 
[Aserto Express.js SDK](https://github.com/aserto-dev/express-jwt-aserto#displaystatemap-middleware) in 
conjunction with the [Aserto React SDK](https://github.com/aserto-dev/aserto-react) that is useful in 
